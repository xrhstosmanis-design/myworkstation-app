...
**26/09 LAB συνέχεια:** η υπάρχουσα περίοδος και οι δύο εσωτερικές τραπεζικές εγγραφές 5,00 € + 14,67 € εμφανίστηκαν σωστά, αλλά τα αποδεικτικά τους εκκρεμούν. Ανοιχτά: ενεργή βάρδια/μετρητά από Platform Admin, έλεγχος 9 εκκρεμών παρουσιών πριν από κλείδωμα, επιβεβαίωση συμφωνίας και πλήρης αποδοχή. `CHECKPOINTS/CHANGES/2026-09-26-workforce-payroll-lab-period-load.md`.

Η ανάγνωση δύο ενεργών βαρδιών `MAIN` / `LAB-POS-02` πέρασε στο LAB μετά το #1343. Ανοιχτά παραμένουν δοκιμαστική πληρωμή μετρητών σε περίοδο με πραγματικό υπόλοιπο, έλεγχος/διόρθωση των 9 παρουσιών, επανυπολογισμός της ήδη πληρωμένης περιόδου όπου χρειαστεί, αποδεικτικά και ασφαλές τελικό κλείδωμα.

Η απογραφή 26/09 εντόπισε 5 εκκρεμείς στις 23/9, 2 στις 24/9 και 2 στις 25/9. Τέσσερις είναι 8+ ωρών, τέσσερις απαιτούν review και μία παραμένει OPEN. Το τρέχον UI δεν επιλύει τις απλές αποκλίσεις ούτε διορθώνει ιστορικό clock-out. Απαιτούνται ελεγχόμενη διόρθωση με Audit, έλεγχος παλιού πληρωμένου snapshot και συμφωνία πριν από lock. Μετά το πλήρες LAB PASS, αναλυτικό εγχειρίδιο εκμάθησης πρέπει να εμφανίζεται μέσα στο πρόγραμμα.

Με οδηγία ιδιοκτήτη εγκρίθηκε η 16ω23λ παρουσία. Η νέα προεπισκόπηση 101,59 € διαφωνεί με το πληρωμένο DRAFT 19,67 €. Η διόρθωση ωρών/έγκριση review και η φραγή stale lock είναι AWAITING LAB. Εκκρεμεί υλοποίηση επανυπολογισμού του πληρωμένου DRAFT, ακριβής διάρκεια για την άλλη ξεχασμένη παρουσία 20ω48λ, έλεγχος των υπόλοιπων εκκρεμοτήτων, εξόφληση και πλήρης cash/lock δοκιμή.

Το #1350 πέρασε CI και η LAB διόρθωση 24ω14λ → 15ω00λ / 75,00 € με ξεχωριστή 8+ έγκριση πέρασε περιορισμένα. Μένουν ο 20ω48λ χωρίς καθορισμένη πραγματική διάρκεια, οι άλλες εκκρεμείς παρουσίες, επανυπολογισμός/συμφωνία του DRAFT (live 176,59 € έναντι πληρωμένων 19,67 €), cash test, lock και αναλυτικό in-app εγχειρίδιο μετά το τελικό PASS.
...
2. Gate 4 και Gate 6 παραμένουν στις ήδη ανατεθειμένες σελίδες. Τα Gate 7 και Gate 8 έχουν PASS, είναι κλειδωμένα και δεν επαναλαμβάνονται.
