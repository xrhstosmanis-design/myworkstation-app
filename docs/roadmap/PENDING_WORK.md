...
| 3 | Χειροκίνητα/αυτόματα τιμολόγια | **ΑΝΑΤΕΘΗΚΕ — `agent/gate3-evidence-recovery-20260925` · OPEN** | Νέα ανάθεση 25/09 μετά την παράδοση #1239. Checkpoint `CHECKPOINTS/CHANGES/2026-09-25-gate3-evidence-recovery-takeover.md`. Διατηρείται KG→GR. Βάση παραλαβής: `CHECKPOINTS/CHANGES/2026-09-25-gate3-handoff-release.md`, `AGENTS.md` § Gate 3 και τη διαπρομηθευτική απογραφή. Τελευταίο πραγματικό LAB: ΜΟΥΧΑΛΗΣ 090387 FAIL 7/158,60 € → 9/246,69 €. ΡΗΓΑΣ ΤΔΑ0086532 περιορισμένο PASS 3/39,83 €. Εκκρεμούν OCR/διπλές γραμμές, ποσότητες/συσκευασίες, εκπτώσεις/ΦΠΑ, αντιστοίχιση προϊόντων και πολλοί προμηθευτές. Κριτήριο έως δύο ορατές αβέβαιες γραμμές, χωρίς χαμένες/διπλές φυσικές σειρές. |
