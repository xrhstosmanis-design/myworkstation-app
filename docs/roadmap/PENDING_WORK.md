...
## 25/09/2026 — Gate 4 σύνδεση έκπτωσης με ενεργό Master προϊόν — DEPLOYED / AWAITING LAB · `agent/gate4-master-audience-discount-20260925`

Η καρτέλα ενεργού ΝΕΡΟ 500ML στον Master Catalog εμφανίζει μωβ κουμπί, αλλά ο διάλογος ομαδικής έκπτωσης μετρά 0 είδη επειδή διαβάζει τη διαφορετική λίστα του αρχείου ειδών. Διορθώνεται η δυνατότητα ορισμού έκπτωσης μόνο στο συγκεκριμένο ενεργό εταιρικό προϊόν με κατάστημα/δικαιούχο/ποσοστό και σαφές αποτέλεσμα. Η πώληση 2 × ΝΕΡΟ 500ML / 0,90 € στις 25/09 08:33 έχει παρατηρηθεί, αλλά δεν αποδεικνύει έκπτωση δικαιούχου έναντι χειροκίνητης αλλαγής τιμής. **LAB PASS εκκρεμεί**· δεν επαναλαμβάνεται παλιά πώληση για συμπλήρωση αρχείου.
...
| 5 | Πληρωμές, πιστώσεις και συμφωνίες | **ΑΝΑΤΕΘΗΚΕ — `agent/gate5-payments-reconciliation` · ΜΕΡΙΚΟ LAB PASS / OPEN** | G5-P02 PASS: 0,10 € ιδιοκτήτη/εταιρικής κάρτας, χωρίς δεύτερη έγκριση, ΔΑ0011467. G5-P03 PASS: 0,10 € χειριστή LAB-POS-02/μετρητά βάρδιας/αποδεικτικό, μία έγκριση ιδιοκτήτη, ΒΒ 6529 και Audit· ξεχωριστή πώληση 0,90 € στο ίδιο POS. Τα δύο ολοκληρωμένα σενάρια αφαιρέθηκαν από τα εκκρεμή· ολική εξόφληση, έξοδα, καταθέσεις, αρνητικοί έλεγχοι και τελική συμφωνία OPEN (checkpoint και `docs/manual/payments/PASS.md`). Όχι Gate 3/4. |
...
3. Gate 1 και Gate 2 έχουν PASS. Το Gate 5 έχει ανατεθεί στο `agent/gate5-payments-reconciliation`, έχει περιορισμένο LAB PASS για G5-P02 (ιδιοκτήτης/εταιρική κάρτα) και G5-P03 (χειριστής/μετρητά ενεργής βάρδιας με έγκριση ιδιοκτήτη) και παραμένει OPEN για την πλήρη οικονομική LAB αποδοχή.
