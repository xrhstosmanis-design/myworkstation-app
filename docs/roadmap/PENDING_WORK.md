...
**Εξαιρέσεις από αυτή τη σελίδα:** Τιμολόγια/OCR και η εξωτερική διασύνδεση efood/Pelican εκτελούνται από τις αντίστοιχες εξειδικευμένες σελίδες. Το γενικό Online Ordering/Delivery του MyWorkStation είναι το Gate 6 και παρακολουθείται εδώ ανεξάρτητα.
...
| 3 | Χειροκίνητα/αυτόματα τιμολόγια | **ΑΝΑΤΕΘΗΚΕ — `agent/gate3-pos-learning-rules-20260925` · OPEN** | Συνέχεια ίδιας σελίδας/owner. Νέο πραγματικό FAIL ΔΕΛΤΑ/ΘΕΟΔΩΡΟΠΟΥΛΟΣ 30721: 18 φυσικές γραμμές/120,94 €, POS 17/127,70 € και Learning 17/115,66 €. Στενή αλλαγή LOCAL FULL PASS: επισκευή οικονομικών, διατήρηση πρόχειρου σε review και κεντρικός versioned χάρτης 12 στηλών ανά ΑΦΜ με οικογένεια/διανομέα για όλα τα καταστήματα, POS + BackOffice. Η `TM` αναγνωρίζεται και πλήρης αναπαραγωγή δίνει 18/85/107,03/120,94 σε δύο καταστήματα. 1.503 tests PASS / 0 FAIL / 1 SKIP και production build PASS· CI/deploy/LAB readback εκκρεμούν. Checkpoint `CHECKPOINTS/CHANGES/2026-09-25-gate3-delta-30721-learning-economics.md`. Δεν έγινε Confirm/Learn ή οικονομική/stock πράξη. Το 30721 δεν επανυποβάλλεται στο POS· για αποδοχή απαιτείται νέο διαφορετικό παραστατικό. Διατηρούνται KG→GR, παλιά PASS/FAIL και η διαπρομηθευτική απογραφή. Εκκρεμούν OCR/διπλές γραμμές, ποσότητες/συσκευασίες, εκπτώσεις/ΦΠΑ, αντιστοίχιση προϊόντων και πολλοί προμηθευτές. |
...
| 6 | Online παραγγελίες και Delivery | **ΑΝΑΤΕΘΗΚΕ — `agent/gate6-online-delivery-20260925` · OPEN** | Γενική ροή MyWorkStation, όχι efood: σωστό κατάστημα και ξεχωριστό online/delivery ταμείο, ετεροχρονισμένη χρέωση, μία αφαίρεση stock, idempotent retry/διπλή παραγγελία, ακύρωση/απόρριψη/ολοκλήρωση και συμφωνία POS–BackOffice–Audit. Η εξωτερική σύνδεση efood/Pelican παραμένει ξεχωριστή και δεν μπλοκάρει αυτό το Gate. |
| 7 | Αναφορές και στατιστικά | **ΠΕΡΙΟΡΙΣΜΕΝΟ LAB PASS / OPEN** | Ολοκληρώθηκαν και δεν επαναλαμβάνονται: ώρα Ελλάδας, κοινή προβολή MAIN/LAB-POS-02 και ανάλυση προϊόντος/χειριστή για την υπάρχουσα πώληση 0,50 € (PR #1280, deploy `be8be8f0`). Εκκρεμούν τα τελικά πραγματικά δεδομένα Gate 3/5/6 και πλήρης συμφωνία ακυρώσεων, voids, επιστροφών, εκπτώσεων, τρόπων πληρωμής και stock/audit. |
...
- Αποδοχή, προετοιμασία, ετοιμότητα, παράδοση, απόρριψη και ακύρωση με ακριβές Audit.
- Συμφωνία POS, BackOffice, βάρδιας, χειριστή, τρόπου πληρωμής και αναφορών.
