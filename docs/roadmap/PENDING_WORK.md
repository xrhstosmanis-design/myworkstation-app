...
| 5 | Πληρωμές, πιστώσεις και συμφωνίες | **ΑΝΑΤΕΘΗΚΕ — `agent/gate5-payments-reconciliation` · ΜΕΡΙΚΟ LAB PASS / OPEN** | G5-P02: μετρημένο PASS μερικής πληρωμής ιδιοκτήτη 0,10 € με εταιρική κάρτα/εικονική τράπεζα, χωρίς δεύτερη έγκριση, audit ΔΑ0011467 (checkpoint και `docs/manual/payments/PASS.md`). Η αντίστοιχη ολοκληρωμένη δοκιμή αφαιρέθηκε από τα εκκρεμή· υπόλοιπα κριτήρια Gate 5 ανοικτά, ειδικά πληρωμή χειριστή POS. Όχι Gate 3/4. |
...
3. Gate 1 και Gate 2 έχουν PASS. Το Gate 5 έχει ανατεθεί στο `agent/gate5-payments-reconciliation`, έχει περιορισμένο LAB PASS μερικής πληρωμής ιδιοκτήτη/εταιρικής κάρτας και παραμένει OPEN για την πλήρη οικονομική LAB αποδοχή.
