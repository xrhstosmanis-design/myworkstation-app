## Gate 5 — προβολή αποδεικτικού και σαφής κατάσταση ελέγχου — ASSIGNED `agent/gate5-review-evidence-access-20260925` / AWAITING CI-LAB

Η μη ελεγμένη πληρωμή εμφανιζόταν σαν απόκλιση, ενώ το αποδεικτικό δεν άνοιγε για άλλη εταιρεία στον Super Admin. Στενή αλλαγή scoped πρόσβασης και ετικέτας· local build/test PASS, CI και LAB read-only εκκρεμούν. Δεν υπάρχει νέο οικονομικό PASS ούτε αυτόματη ανάγνωση του αρχείου.

## Gate 5 — ένδειξη αυτόματης συμφωνίας αποδεικτικού — ASSIGNED `agent/gate5-proof-check-truth-20260925` / AWAITING LAB

Το υπάρχον endpoint δεν διαβάζει ποσό ή μέθοδο μέσα στο PDF/image και εμφανίζει `matched` από ύπαρξη αρχείου και ίσο άθροισμα τιμολογίων. Στενή αλλαγή προειδοποίησης πριν από επιβεβαίωση, χωρίς οικονομική μετάλλαξη· CI #3182 PASS, ακριβές Render `52b70a162e6f82e2aa69104564845920f64cde6e`· απαιτείται read-only LAB επιβεβαίωση. Η ουσιαστική αυτόματη ανάγνωση και συμφωνία αποδεικτικού, API/race και τελική συμφωνία Gate 5 παραμένουν OPEN.
...
| 3 | Χειροκίνητα/αυτόματα τιμολόγια | **ΑΝΑΤΕΘΗΚΕ — `agent/gate3-explicit-conversion-priority-20260925` · OPEN** | Νέα ανάθεση 25/09 μετά την παράδοση #1239. Checkpoint `CHECKPOINTS/CHANGES/2026-09-25-gate3-evidence-recovery-takeover.md`. Διατηρείται KG→GR. Βάση παραλαβής: `CHECKPOINTS/CHANGES/2026-09-25-gate3-handoff-release.md`, `AGENTS.md` § Gate 3 και τη διαπρομηθευτική απογραφή. Τελευταίο πραγματικό LAB: ΜΟΥΧΑΛΗΣ 090387 FAIL 7/158,60 € → 9/246,69 €. ΡΗΓΑΣ ΤΔΑ0086532 περιορισμένο PASS 3/39,83 €. Εκκρεμούν OCR/διπλές γραμμές, ποσότητες/συσκευασίες, εκπτώσεις/ΦΠΑ, αντιστοίχιση προϊόντων και πολλοί προμηθευτές. Κριτήριο έως δύο ορατές αβέβαιες γραμμές, χωρίς χαμένες/διπλές φυσικές σειρές. |
...
| 5 | Πληρωμές, πιστώσεις και συμφωνίες | **ΑΝΑΤΕΘΗΚΕ — `agent/gate5-payments-reconciliation` · ΜΕΡΙΚΟ LAB PASS / OPEN** | G5-P02–P07 περιορισμένα LAB PASS. G5-P08 **περιορισμένο LAB PASS ακύρωσης**: PR #1237/#1241, CI #3135/#3143, Render `90ec8b7`: μία ακύρωση FRESH/ΒΒ 6529 46,92 € επανέφερε ουρά και δεσμεύσεις σε 0 €, οφειλή 46,92 €, POS2 ενεργές κινήσεις 17→16 και έξοδα 47,12→0,20 €, πωλήσεις 7,50 € ίδιες. POS1 έκλεισε παράλληλα, τράπεζα/audit ακύρωσης NOT TESTED. Audit ακύρωσης μία γραμμή 12:36/FRESH 46,92 € μετά PR #1243, LAB τράπεζα 3,30 € επιβεβαιωμένο/0 € αναμονή, ΚΑΤ 22,36 € ίδιο· χειριστής ως τεχνικό ID. Η αρχική λάθος CASH_SHIFT μέθοδος ιστορικό FAIL. G5-P09 ολική εικονική τραπεζική εξόφληση ιδιοκτήτη 46,92 € περιορισμένο LAB PASS, επιβεβαιωμένο LAB 3,30→−43,62 €, οφειλή 0, ουρά 0, POS1/POS2/ΚΑΤ ίδια. Αρνητικό LAB υπόλοιπο καταγεγραμμένο· UI ποσού/πληκτρολογίου desktop LAB PASS μετά PR #1250/CI #3165/Render `a3a1a040`, μικρή οθόνη/φυσικό POS NOT TESTED. G5-P10 υπερπληρωμή +0,01 € έχει μόνο UI LAB PASS με αμετάβλητους μάρτυρες· API/race, διπλή υποβολή, απόκλιση αποδεικτικού και τελική συμφωνία OPEN. Όχι Gate 3/4. |
