...
| 3 | Χειροκίνητα/αυτόματα τιμολόγια | **ΑΝΑΤΕΘΗΚΕ — `agent/gate3-preserve-stock-learning-20260925` · OPEN** | Νέα ανάθεση 25/09 μετά την παράδοση #1239. Checkpoint `CHECKPOINTS/CHANGES/2026-09-25-gate3-evidence-recovery-takeover.md`. Διατηρείται KG→GR. Βάση παραλαβής: `CHECKPOINTS/CHANGES/2026-09-25-gate3-handoff-release.md`, `AGENTS.md` § Gate 3 και τη διαπρομηθευτική απογραφή. Τελευταίο πραγματικό LAB: ΜΟΥΧΑΛΗΣ 090387 FAIL 7/158,60 € → 9/246,69 €. ΡΗΓΑΣ ΤΔΑ0086532 περιορισμένο PASS 3/39,83 €. Εκκρεμούν OCR/διπλές γραμμές, ποσότητες/συσκευασίες, εκπτώσεις/ΦΠΑ, αντιστοίχιση προϊόντων και πολλοί προμηθευτές. Κριτήριο έως δύο ορατές αβέβαιες γραμμές, χωρίς χαμένες/διπλές φυσικές σειρές. |
...
| 5 | Πληρωμές, πιστώσεις και συμφωνίες | **ΑΝΑΤΕΘΗΚΕ — `agent/gate5-payments-reconciliation` · ΜΕΡΙΚΟ LAB PASS / OPEN** | G5-P02–P07 περιορισμένα LAB PASS. G5-P08 **περιορισμένο LAB PASS ακύρωσης**: PR #1237/#1241, CI #3135/#3143, Render `90ec8b7`: μία ακύρωση FRESH/ΒΒ 6529 46,92 € επανέφερε ουρά και δεσμεύσεις σε 0 €, οφειλή 46,92 €, POS2 ενεργές κινήσεις 17→16 και έξοδα 47,12→0,20 €, πωλήσεις 7,50 € ίδιες. POS1 έκλεισε παράλληλα, τράπεζα/audit ακύρωσης NOT TESTED. Audit ακύρωσης μία γραμμή 12:36/FRESH 46,92 € μετά PR #1243, LAB τράπεζα 3,30 € επιβεβαιωμένο/0 € αναμονή, ΚΑΤ 22,36 € ίδιο· χειριστής ως τεχνικό ID. Η αρχική λάθος CASH_SHIFT μέθοδος ιστορικό FAIL. Ολική εξόφληση, αρνητικοί έλεγχοι και τελική συμφωνία OPEN. Όχι Gate 3/4. |
