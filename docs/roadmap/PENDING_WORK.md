...
Η ατομική αποθήκευση 10% / Ιατροί / LAB στο ΝΕΡΟ 500ML έχει USER PASS 09:15. Η μαζική επιλογή και απάντηση αποθήκευσης 10% σε 2 ενεργά προϊόντα ΝΕΡΟ 1,5LT / EVIAN 500ML έχουν χωριστό USER PASS 10:01 (PR #1215, CI #3078, deploy `558cc179`). Το καλάθι φυσικού LAB POS 2 / Ιατρός έδειξε στις 10:28 1,00→0,90 € και 1,50→1,40 €, σύνολο 2,30 €, σύμφωνα με τον προϋπάρχοντα κανόνα στρογγυλοποίησης προς τα πάνω στο επόμενο 0,10 € ανά γραμμή: **USER PASS εμφάνισης καλαθιού μόνο**. **Τα τρία ολοκληρωμένα σκέλη αφαιρέθηκαν από τις εκκρεμότητες και δεν επαναλαμβάνονται.** Εκκρεμούν ανεξάρτητος έλεγχος κανόνα/Audit, checkout και επιδράσεις σε βάρδιες/stock με νέο μετρημένο baseline· η πώληση 08:33 2 × ΝΕΡΟ 500ML / 0,90 € δεν αποδεικνύει έκπτωση δικαιούχου έναντι χειροκίνητης τιμής. Δεν έγινε πληρωμή στο καλάθι 10:28. Συνολικό Gate 4 PENDING.
