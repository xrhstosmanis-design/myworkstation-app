...
| 3 | Χειροκίνητα/αυτόματα τιμολόγια | **ΑΝΑΤΕΘΗΚΕ — `agent/gate3-pos-learning-rules-20260925` · OPEN** | Συνέχεια ίδιας σελίδας/owner. Νεότερο πραγματικό FAIL: COFFEE UNION `ΤΔΑ0009902`, exact learning δεν εφαρμόστηκε (`DEL005` 4% αντί 25%, `FR1500` 48 αντί 4.800 pcs) και το POS χαρακτήρισε λανθασμένα διαφορά 3,24 € ως ΟΚ. Στενή διόρθωση LOCAL targeted PASS / AWAITING CI, deploy και άλλο νέο POS τιμολόγιο· checkpoint `CHECKPOINTS/CHANGES/2026-09-25-gate3-pos-exact-learning-rules.md`. Διατηρούνται KG→GR, παλιά PASS/FAIL και η διαπρομηθευτική απογραφή. Εκκρεμούν OCR/διπλές γραμμές, ποσότητες/συσκευασίες, εκπτώσεις/ΦΠΑ, αντιστοίχιση προϊόντων και πολλοί προμηθευτές. Κριτήριο έως δύο ορατές αβέβαιες γραμμές, χωρίς χαμένες/διπλές φυσικές σειρές. |
