...
| 3 | Χειροκίνητα/αυτόματα τιμολόγια | **ΑΝΑΤΕΘΗΚΕ - ΑΛΛΗ ΣΕΛΙΔΑ · ΜΕΡΙΚΟ LAB PASS / OPEN** | Κοινός κανόνας `AGENTS.md` § Gate 3 και `CHECKPOINTS/CHANGES/2026-09-25-gate3-shared-acceptance-rule.md`: σύγκριση πρώτου αυτόματου POS πρόχειρου με φυσικές σειρές, ποσότητες, τιμές, εκπτώσεις, ΦΠΑ για πολλούς προμηθευτές· πριν/μετά ανά παραστατικό και προστασία παλαιών PASS. ΡΗΓΑΣ ΤΔΑ0086532 περιορισμένο PASS 3/39,83 €, ΜΟΥΧΑΛΗΣ 090387 FAIL 7/158,60 € → 9/246,69 €. Η προβολή πρόχειρου ΡΗΓΑΣ έχει χωριστό USER/LAB PASS διάταξης, όχι νέα αποδοχή OCR. Εκκρεμούν σύνδεση προϊόντων, ΠΑΚ/τεμάχια και άλλοι προμηθευτές. Έως δύο ορατές γραμμές προς έλεγχο σύμφωνα με το υπάρχον όριο. |
