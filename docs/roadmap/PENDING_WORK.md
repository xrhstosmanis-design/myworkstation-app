...
Η ατομική αποθήκευση 10% / Ιατροί / LAB στο ΝΕΡΟ 500ML έχει USER PASS 09:15. Η μαζική επιλογή και απάντηση αποθήκευσης 10% σε 2 ενεργά προϊόντα ΝΕΡΟ 1,5LT / EVIAN 500ML έχουν USER PASS 10:01 (PR #1215, CI #3078, deploy `558cc179`). Το καλάθι φυσικού LAB POS 2 / Ιατρός είχε USER PASS 10:28: 1,00→0,90 € και 1,50→1,40 €, σύνολο 2,30 € με υφιστάμενη στρογγυλοποίηση γραμμής προς το επόμενο 0,10 €. Η **μία πώληση 10:49:31 έχει μετρημένο LAB PASS**: μετρητά 2,30 €, POS02 14→15 κινήσεις και 5,20→7,50 €, POS01 αμετάβλητο, stock 2270 −6→−7 και EVIAN 0→−1, Sale/Audit «Ιατρός» με ίδιο ποσό/ώρα. **Τα ολοκληρωμένα σκέλη αποθήκευσης, καλαθιού και αυτής της πώλησης αφαιρέθηκαν από τις εκκρεμότητες και δεν επαναλαμβάνονται.** Εκκρεμούν μόνο ανεξάρτητος έλεγχος του παλιού before/after κανόνα και Audit μαζικής μεταβολής όπου υπάρχουν παλαιά τεκμήρια, μη επιλεγμένα/τρίτο είδος, άλλοι δικαιούχοι/καταστήματα και λοιπά σκέλη Gate 4. Δεν επαναλαμβάνεται πώληση ή αποθήκευση μόνο για να καλυφθεί απουσία παλιού baseline. Συνολικό Gate 4 PENDING.

**Νέα περιορισμένη ανάθεση 25/09 — `agent/gate4-audience-discount-audit-read-20260925`:** το υπάρχον Audit αποθήκευσης έκπτωσης γράφεται, αλλά δεν είχε ορατή διαδρομή ανάγνωσης. Προστίθεται ανάγνωση στο Master Catalog αποκλειστικά για τον εξουσιοδοτημένο ιδιοκτήτη και το δικό του κατάστημα, ώστε να ανακτηθεί η παλιά εγγραφή 10:01 χωρίς νέα αποθήκευση. SOURCE FINDING / AWAITING CI, deploy και ανάγνωση LAB, όχι PASS του ιστορικού. Η εγγραφή μετά την αλλαγή δεν αποδεικνύει το προγενέστερο ποσοστό ή τα μη επιλεγμένα προϊόντα.
...
| 3 | Χειροκίνητα/αυτόματα τιμολόγια | **ΑΝΑΤΕΘΗΚΕ - ΑΛΛΗ ΣΕΛΙΔΑ · ΜΕΡΙΚΟ LAB PASS / OPEN** | Το νέο ΡΗΓΑΣ ΤΔΑ0086532 συμφώνησε σε 3 φυσικές σειρές και 39,83 € (`docs/manual/invoices/PASS.md`). Η προβολή του υπάρχοντος πρόχειρου ΡΗΓΑΣ έχει ξεχωριστό USER/LAB PASS διάταξης 25/09 (checkpoint/manual)· δεν αποτελεί νέα αποδοχή τιμολογίου. Εκκρεμούν σύνδεση προϊόντων, μετατροπή ΠΑΚ/τεμαχίων και δοκιμές άλλων προμηθευτών. Ισχύει ο κανόνας έως δύο ορατών γραμμών προς έλεγχο. |
...
| 5 | Πληρωμές, πιστώσεις και συμφωνίες | **ΑΝΑΤΕΘΗΚΕ — `agent/gate5-payments-reconciliation` · ΜΕΡΙΚΟ LAB PASS / OPEN** | G5-P02–P05 περιορισμένα LAB PASS (checkpoint/manual). G5-P06 PASS 25/09: μία εξωτερική δαπάνη ιδιοκτήτη 0,10 €, επιβεβαιωμένο LAB τραπεζικό 3,40→3,30 € χωρίς δεύτερη έγκριση, POS1/POS2 και ΚΑΤ ίδια. Η διαδρομή δαπάνης ιδιοκτήτη αφαιρέθηκε από τα εκκρεμή. Ολική εξόφληση, **έξοδο χειριστή POS**, απόκλιση αποδεικτικού, αρνητικοί έλεγχοι και τελική συμφωνία OPEN. Η διόρθωση γενικού refresh της ουράς ιδιοκτήτη αναπτύχθηκε στο `2522dad5`, αλλά μετάβαση stale→fresh σε LAB παραμένει για επανέλεγχο. Όχι Gate 3/4. |
...
1. Gate 3 παραμένει αποκλειστικά στην ήδη υπεύθυνη σελίδα τιμολογίων.
