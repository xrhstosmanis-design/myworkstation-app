...
## 25/09/2026 — Gate 4 Master έκπτωση: μαζική επιλογή και POS εφαρμογή — ASSIGNED `agent/gate4-master-bulk-audience-20260925`

Ατομική αποθήκευση 10% / Ιατροί / LAB στο ΝΕΡΟ 500ML 2269-5201219000118: USER PASS 09:15, καταγράφηκε στο `docs/manual/products-master-catalog/PASS.md` και αφαιρέθηκε ως εκκρεμότητα. Νέα απαίτηση: επιλογή ενεργών προϊόντων με checkbox και τρόπος «Ένα προϊόν / Μαζικά» στην ίδια οθόνη, με ρητό πλήθος και επιβεβαίωση. Η μαζική ενέργεια, Audit κανόνα και POS εφαρμογή παραμένουν NOT TESTED. Πώληση 08:33 2 × ΝΕΡΟ 500ML / 0,90 € δεν αποδεικνύει έκπτωση δικαιούχου και δεν επαναλαμβάνεται για καταγραφή.
...
3. Gate 1 και Gate 2 έχουν PASS. Το Gate 5 έχει ανατεθεί στο `agent/gate5-payments-reconciliation`, έχει περιορισμένο LAB PASS για G5-P02 (ιδιοκτήτης/εταιρική κάρτα) G5-P03 (χειριστής/μετρητά ενεργής βάρδιας με έγκριση ιδιοκτήτη) και G5-P04 (μία κατάθεση με μεταγενέστερο αποδεικτικό) και παραμένει OPEN για την πλήρη οικονομική LAB αποδοχή.
