...
Η ατομική αποθήκευση 10% / Ιατροί / LAB στο ΝΕΡΟ 500ML έχει USER PASS 09:15. Η μαζική επιλογή και απάντηση αποθήκευσης 10% σε 2 ενεργά προϊόντα ΝΕΡΟ 1,5LT / EVIAN 500ML έχουν χωριστό USER PASS 10:01 (PR #1215, CI #3078, deploy `558cc179`). **Τα δύο ολοκληρωμένα σκέλη αφαιρέθηκαν από τις εκκρεμότητες και δεν επαναλαμβάνονται.** Εκκρεμούν μόνο ανεξάρτητος έλεγχος κανόνα/Audit και εφαρμογή στο POS με νέο μετρημένο baseline· η πώληση 08:33 2 × ΝΕΡΟ 500ML / 0,90 € δεν αποδεικνύει έκπτωση δικαιούχου έναντι χειροκίνητης τιμής. Συνολικό Gate 4 PENDING.
...
| 5 | Πληρωμές, πιστώσεις και συμφωνίες | **ΑΝΑΤΕΘΗΚΕ — `agent/gate5-payments-reconciliation` · ΜΕΡΙΚΟ LAB PASS / OPEN** | G5-P02 PASS: 0,10 € ιδιοκτήτη/εταιρικής κάρτας, χωρίς δεύτερη έγκριση, ΔΑ0011467. G5-P03 PASS: 0,10 € χειριστή LAB-POS-02/μετρητά βάρδιας/αποδεικτικό, μία έγκριση ιδιοκτήτη, ΒΒ 6529 και Audit· ξεχωριστή πώληση 0,90 € στο ίδιο POS. G5-P04 PASS: μία κατάθεση 0,10 € LAB POS 2, μεταγενέστερο ισόποσο PDF και αυτόματη επιβεβαίωση. G5-P05 PASS: κατάθεση 0,10 € με αρχικό PDF → αναμονή ελέγχου → μία έγκριση ιδιοκτήτη, διαφορά 0. Τα τέσσερα ολοκληρωμένα σενάρια αφαιρέθηκαν από τα εκκρεμή· ολική εξόφληση, έξοδα, απόκλιση αποδεικτικού, αρνητικοί έλεγχοι και τελική συμφωνία OPEN. Η διόρθωση γενικού refresh της ουράς ιδιοκτήτη περιμένει CI/deploy/LAB retest (checkpoint και `docs/manual/payments/PASS.md`). Όχι Gate 3/4. |
