...
- Ρέστα, εκπτώσεις, ακύρωση μετά ολοκλήρωση, επανεκτύπωση και επαλήθευση Audit. **Η ακύρωση καλαθιού πριν από πληρωμή αφαιρέθηκε μετά από πραγματικό LAB PASS με πριν/μετά στις 24/09**, όπως και οι χωριστά καταγεγραμμένες πλήρης/μερική επιστροφή· δεν επαναλαμβάνονται για αυτό το σκέλος.
