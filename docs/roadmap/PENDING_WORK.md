...
- **ΑΝΑΤΕΘΗΚΕ — `agent/gate4-void-history-fix` (24/09/2026):** Στο LAB-POS-02 το IRIS VOID 0,50 € μείωσε σωστά τη βάρδια 4,30→3,80 €, αλλά το ιστορικό το ονομάζει «Επιστροφή» (`LAB FAIL` προβολής). Διόρθωση μόνο ταξινόμησης/διπλής προβολής, CI/merge/exact deploy, επανάγνωση της ίδιας κίνησης και έλεγχος stock SKU 2269 πριν κλείσει αυτό το σκέλος. Καμία επανάληψη VOID. Checkpoint: `CHECKPOINTS/CHANGES/2026-09-24-gate4-void-iris-history-awaiting-lab.md`.
