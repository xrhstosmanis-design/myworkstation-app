...
**Ολοκληρώθηκε 25/09 — τωρινή ανάγνωση κανόνων τεσσάρων ομάδων LAB:** Ιατροί 3 ενεργοί κανόνες 10%, Νοσηλευτές 1 ενεργός κανόνας 20% για SKU 2273, Προσωπικό 0, Πελάτες 0. Τα IDs και Audit των ενεργών κανόνων δεν άλλαξαν από τις καταγεγραμμένες αποθηκεύσεις. Περιορισμένο PASS read-only snapshot σε ένα κατάστημα· η επανάγνωση των ίδιων κανόνων αφαιρείται από τα pending. Ιστορική αμεταβλητότητα, POS τιμές Προσωπικού/Πελάτη, απομόνωση άλλου καταστήματος και συνολικό Gate 4 OPEN. Χωρίς νέα πώληση ή αποθήκευση.
...
| 3 | Χειροκίνητα/αυτόματα τιμολόγια | **ΑΝΑΤΕΘΗΚΕ — `agent/gate3-stock-unit-readback-20260925` · OPEN** | Νέα ανάθεση 25/09 μετά την παράδοση #1239. Checkpoint `CHECKPOINTS/CHANGES/2026-09-25-gate3-evidence-recovery-takeover.md`. Διατηρείται KG→GR. Βάση παραλαβής: `CHECKPOINTS/CHANGES/2026-09-25-gate3-handoff-release.md`, `AGENTS.md` § Gate 3 και τη διαπρομηθευτική απογραφή. Τελευταίο πραγματικό LAB: ΜΟΥΧΑΛΗΣ 090387 FAIL 7/158,60 € → 9/246,69 €. ΡΗΓΑΣ ΤΔΑ0086532 περιορισμένο PASS 3/39,83 €. Εκκρεμούν OCR/διπλές γραμμές, ποσότητες/συσκευασίες, εκπτώσεις/ΦΠΑ, αντιστοίχιση προϊόντων και πολλοί προμηθευτές. Κριτήριο έως δύο ορατές αβέβαιες γραμμές, χωρίς χαμένες/διπλές φυσικές σειρές. |
