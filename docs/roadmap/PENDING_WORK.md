...
**26/09 νεότερο LAB:** εννέα εκκρεμείς εικονικές παρουσίες ελέγχθηκαν, preview 313,00 €, παλιό πληρωμένο DRAFT 19,67 €· το stale lock απορρίφθηκε. Ασφαλής επανυπολογισμός AWAITING CI/DEPLOY/LAB, έπειτα 293,33 € αναμενόμενο υπόλοιπο για cash/τράπεζα και τελικό lock. Αναλυτικό in-app manual μετά το πλήρες PASS.
