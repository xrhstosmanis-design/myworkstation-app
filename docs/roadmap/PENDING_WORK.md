...
> **Gate 4 — AWAITING LAB:** Μικτή πώληση POS01 1,00 € (μετρητά 0,50 € + κάρτα 0,50 €) εμφανίστηκε στο Backoffice ως 1,00 € μετρητά. Η διορθωμένη προβολή χρειάζεται CI/deploy και επανάγνωση της ίδιας συναλλαγής, χωρίς νέα πώληση. Βλ. `CHECKPOINTS/CHANGES/2026-09-24-gate4-mixed-payment-shift-projection-awaiting-lab.md`.
