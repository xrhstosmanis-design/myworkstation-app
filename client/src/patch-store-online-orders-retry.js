...
if(source.includes(oldCached)){
  source=source.replace(oldCached,newCached);
  changed=true;
}
...
console.log(changed?"Store Online Orders retry safety ready.":"Store Online Orders retry patch not needed for current component.");
