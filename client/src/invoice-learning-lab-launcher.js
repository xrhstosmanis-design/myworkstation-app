if(window.location.pathname.replace(/\/+$/,'')==='/platform-admin'){
  ...
  const install=()=>{
    ...
    button.type='button';
    button.dataset.invoiceLearningLabLaunch='1';
    button.textContent='🧠 Invoice Learning Lab';
    button.style.cssText='padding:10px 14px;border:0;border-radius:9px;background:#7c3aed;color:#fff;font-weight:900;cursor:pointer;box-shadow:0 6px 18px #7c3aed33';
