...
export default function PlatformAdminApp(){
  ...
  return <div className="platform-shell">
    <header className="platform-header">
      ...
      <div className="platform-user"><div><small>Platform Owner</small><b>{user.fullName}</b></div><ScreenRecorderControl contextLabel="MYWORKSTATION · PLATFORM ADMIN"/><a href="/" target="_blank" rel="noreferrer" title="Ανοίγει σε νέα καρτέλα ώστε να συνεχίζεται η εγγραφή οθόνης"><ExternalLink/>Backoffice ΚΑΤ</a><button onClick={()=>setShowSecurity(true)}><ShieldCheck/>Ασφάλεια</button><button onClick={()=>logout()}><LogOut/>Έξοδος</button></div>
    </header>
