...
import SuperAdminAnalyticsCenter from "./SuperAdminAnalyticsCenter.jsx";
...
export default function PlatformAdminApp(){
  ...
  const [showSuperAdminAnalytics,setShowSuperAdminAnalytics]=useState(false);
  ...
  return <div className="platform-shell">
    ...
    {showSuperAdminAnalytics&&<SuperAdminAnalyticsCenter request={request} companies={data?.companies||[]} onClose={()=>setShowSuperAdminAnalytics(false)}/>}
