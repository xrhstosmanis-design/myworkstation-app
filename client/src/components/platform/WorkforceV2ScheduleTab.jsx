...
export default function WorkforceV2ScheduleTab({company,store,request,data}){
  ...
  const [view,setView]=useState("DAILY"),[validation,setValidation]=useState(null),[editing,setEditing]=useState(null),[assignmentError,setAssignmentError]=useState(""),[leaveForm,setLeaveForm]=useState({employeeId:"",leaveType:"DAY_OFF",startDate:today(),endDate:today(),comments:""});
