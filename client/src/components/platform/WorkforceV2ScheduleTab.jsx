...
export default function WorkforceV2ScheduleTab({company,store,request,data}){
  ...
  const [reasonDialog,setReasonDialog]=useState(null),[reasonText,setReasonText]=useState(""),[aiText,setAiText]=useState(""),[aiPreview,setAiPreview]=useState(null);
