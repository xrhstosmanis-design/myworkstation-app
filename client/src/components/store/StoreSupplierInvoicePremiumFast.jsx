...
export default function StoreSupplierInvoicePremiumFast({api,store,suppliers=[],onChanged,setMessage}){
  ...
  const selectFiles=async selected=>{
    ...
    try{
      ...
      // Keep provider work sequential. The LAB-proven path was one page followed
      // by the other; concurrent page requests exhausted the shared provider and
      // made both otherwise valid pages fail together.
