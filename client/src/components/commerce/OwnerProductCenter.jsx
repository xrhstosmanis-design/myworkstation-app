...
const productQualityIssues=product=>{
  const issues=[];
  const sale=n(product.salePrice),cost=n(product.costPrice),barcodes=product.barcodes||[];
  ...
  if(sale<=0)issues.push("Χωρίς λιανική");
  if(cost>0&&sale>0&&cost>=sale)issues.push("Κόστος ≥ λιανική");
