...
export default function AdvancedSalesAnalytics({api,stores=[],initialStoreId=""}){
  ...
  const [drawerOpen,setDrawerOpen]=useState(false),[drawerTab,setDrawerTab]=useState("ledger"),[error,setError]=useState(""),[busy,setBusy]=useState(false);
