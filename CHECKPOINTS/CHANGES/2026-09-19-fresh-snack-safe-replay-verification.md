...
- The diagnostic recovery route obtains that supplier from the linked existing draft after reconstructing a lost handoff; it still uses the original attachment and never creates a new draft.
