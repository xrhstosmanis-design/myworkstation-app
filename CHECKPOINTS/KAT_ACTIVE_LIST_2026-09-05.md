...
- [ ] Περιορισμένη διόρθωση: ανάγνωση της τυπωμένης οριζόντιας αλυσίδας `ΦΑΚ` μόνο όταν εννέα αριθμητικές στήλες συμφωνούν μεταξύ τους, με ήδη αναγνωρισμένη ποσότητα/καθαρή/ΦΠΑ· μη αποδοχή ατεκμηρίωτης έκπτωσης >95% ως δομικά ασφαλούς. Τοπικό regression PASS, εκκρεμούν πλήρης suite, CI, merge, exact deploy και **διαφορετική νέα γνήσια LAB υποβολή**. Καμία έγκριση, απόθεμα, λογιστική ή fiscal κίνηση.
