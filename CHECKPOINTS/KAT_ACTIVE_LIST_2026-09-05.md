...
- [x] Προστέθηκε λίστα αποθήκης ανά κατάστημα με απόθεμα, κόστος, λιανική και επιλογή οποιουδήποτε barcode για αυτόματη αναζήτηση.
- [x] Προστέθηκε ασφαλής βαθμολόγηση ακριβούς/πιθανής/μη συγκρίσιμης αντιστοίχισης βάσει barcode, ποσότητας, συσκευασίας και παραλλαγής.
- [x] Η πρόταση παραγγελίας αποκλείει μη συγκρίσιμα αποτελέσματα και ενεργοποιείται μόνο για ίδιο barcode ή ρητά επιβεβαιωμένη πιθανή αντιστοίχιση.
- [ ] Εκκρεμεί CI, Render deploy και LAB PASS της ασφαλούς σύγκρισης από προϊόν αποθήκης.
