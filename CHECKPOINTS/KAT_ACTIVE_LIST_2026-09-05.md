...
| LAB-04 | LAB-POS-01 και LAB-POS-02 με κοινή αποθήκη, κοινό store ledger και ξεχωριστά terminal sessions/βάρδιες. Το runtime POS ενοποιήθηκε με του ΚΑΤ· απομένει CI, Render και πραγματική LAB δοκιμή. | ΣΕ ΕΛΕΓΧΟ - runtime safety follow-up pending CI |
...
- 2026-09-07: follow-up προστασίας LAB POS: διαγράφεται μία φορά η legacy μη δεσμευμένη σύνδεση και το POS δεν εμφανίζεται πριν επιβεβαιωθεί η κατάσταση βάρδιας. Έτσι δεν επιτρέπεται παράκαμψη της καταμέτρησης έναρξης.
