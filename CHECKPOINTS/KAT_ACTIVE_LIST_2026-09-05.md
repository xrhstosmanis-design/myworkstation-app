...
- 2026-09-08: Η ανοιχτή απογραφή προσαρμόζει πλέον το αναμενόμενο υπόλοιπο κάθε επιλεγμένου είδους από κάθε μεταγενέστερη κίνηση stock, με ξεχωριστό audit adjustment. Η αρχική εικόνα και ώρα απογραφής διατηρούνται, ενώ η πώληση παραμένει επιτρεπτή. Απαιτούνται CI και LAB δοκιμή.
