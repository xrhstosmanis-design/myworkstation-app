...
- [ ] PR #1188: CI #3015 PASS, merge `54deda3f5b974b1c87a082af1430c97245d7348f`. Το δημόσιο Render `/api/health` επέστρεψε ακριβώς αυτό το revision στις 25/09. Η προεπισκόπηση της υπάρχουσας πώλησης έχει περιορισμένο πραγματικό PASS· η έξοδος σε χαρτί και η ορατότητα κεντρικού Audit παραμένουν ανεπιβεβαίωτες. Χρησιμοποιείται μόνο η υπάρχουσα πώληση POS02 23:22:35, χωρίς νέα πώληση.
- [ ] Στις «Συναλλαγές βάρδιας» προστέθηκε κουμπί «Εκτύπωση αντιγράφου NON_FISCAL» μόνο σε ήδη καταχωρισμένες πωλήσεις της ορατής ενεργής βάρδιας. Πρώτα καταγράφει `NON_FISCAL_COPY_PRINT_REQUEST` στο Audit, έπειτα δημιουργεί αντίγραφο από τα αποθηκευμένα στοιχεία πώλησης με σαφή ένδειξη ότι δεν είναι φορολογική απόδειξη. Δεν καλεί checkout, δεν ανοίγει βάρδια, δεν αλλάζει stock/ταμείο και δεν εκτυπώνει μέσω fiscal bridge. **LAB PASS μόνο για το περιεχόμενο της φυσικής προεπισκόπησης.** POS02 10 κινήσεις / 3,80 € μετρητά / 4,30 € σύνολο, POS01 1 / 0,50 € μετρητά + 0,50 € κάρτα, SKU 2269 −57, τελευταία 23:22:35. Η κεντρική οθόνη Audit απέκλειε το νέο actionType· διόρθωση προβολής και ανάγνωση της ίδιας εγγραφής χωρίς δεύτερη εκτύπωση. Φυσικό χαρτί δεν έχει επιβεβαιωθεί. Καμία νέα πώληση. Checkpoint: `CHECKPOINTS/CHANGES/2026-09-24-gate4-before-after-test-protocol.md`.
