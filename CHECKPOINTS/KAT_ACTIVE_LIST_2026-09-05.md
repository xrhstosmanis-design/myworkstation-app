## 2026-09-24 — Gate 4 VOID IRIS / ιστορικό βάρδιας — LAB FAIL στην ένδειξη, AWAITING LAB διόρθωσης
...
- [ ] Το POS02 ιστορικό εμφανίζει τη νέα κίνηση −0,50 € ως «Επιστροφή» αντί «ΑΚΥΡΩΣΗ / VOID». Το διαθέσιμο `reversalKind=CANCEL` αγνοείται από τη συγκεκριμένη προβολή. Περιορισμένη διόρθωση της ταξινόμησης και αποφυγή δεύτερης εμφάνισης του ίδιου VOID από το ledger. Αναμονή CI/merge/exact deploy και επανάγνωσης **της υπάρχουσας κίνησης**, χωρίς νέο VOID. Stock ΝΕΡΟ 500ML (SKU 2269) δεν έχει ακόμη διασταυρωθεί πριν/μετά· συνολικό Gate 4 PENDING.
