## 26/09/2026 15:52 (Ελλάδα) — ΥΦΑΝΤΗΣ επανανάγνωση, οικονομικά σωστά / κωδικός λάθος

`image(20260926-125201).png` και `125217` μετά exact Render `3e0a5dac`: διαδραστικός βοηθός 8 φυσικές γραμμές, ποσότητα 28, μετατροπή των τυπωμένων εκπτώσεων γραμμής σε ισοδύναμα ποσοστά ~40%, καθαρό 42,32 €, ΦΠΑ 5,50 €, πληρωτέο 47,82 €, διαφορά 0,00 €. Η οικονομική προεπισκόπηση συμφωνεί, αλλά **συνολικό LAB FAIL προϊόντων**· δεν εφαρμόστηκαν γραμμές. Εντοπίστηκε **LAB FAIL κωδικού σειράς 2**: ΜΟΡΤΑΔΕΛΑ τυπωμένος 703717, βοηθός 703177 (ίδιος με σειρά 1), παρότι τα σύνολα συμφωνούν. Αυτό χρειάζεται διόρθωση στον πίνακα από ελεγκτή πριν από επιλογή/εφαρμογή και αιτιολογεί ότι οικονομική συμφωνία δεν είναι πλήρες PASS προϊόντων. Το πρώτο αυτόματο πρόχειρο A1-92236 παραμένει 0 γραμμές / FAIL· νέο POS first-draft NOT TESTED. Καμία δεύτερη υποβολή/πληρωμή, stock ή οριστικοποίηση.
