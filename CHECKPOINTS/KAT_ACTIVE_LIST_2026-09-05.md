## 2026-09-24 — ΠΗΓΑΣΟΣ 514/18597: τυπωμένη μικρή έκπτωση — LOCAL PASS / AWAITING CI + LAB
...
- [ ] Πλήρης suite, πράσινο CI, merge, ακριβές deploy και **νέο διαφορετικό** πραγματικό LAB τιμολόγιο. Η διόρθωση αφαιρεί ένα αποδεδειγμένο εμπόδιο, δεν αποδεικνύει ότι διορθώθηκαν οι υπόλοιπες στήλες, τα διπλά ή η ποιότητα OCR. Απαιτούνται όλες οι φυσικές σειρές, έως δύο ορατές `ΠΡΟΣ ΕΛΕΓΧΟ`, σωστές ποσότητες, εκπτώσεις, ΦΠΑ, τελικό ποσό πριν από έγκριση και καμία stock/fiscal/λογιστική μεταβολή στη δοκιμή.
...
- Η επίσημη σειρά παραμένει Gate 1-8. Gate 1, Gate 2 και Gate 5 έχουν PASS και δεν επαναλαμβάνονται. Gate 3 έχει ανατεθεί σε άλλη σελίδα.
