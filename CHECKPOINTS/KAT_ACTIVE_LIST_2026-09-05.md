...
| --- | --- | --- |
| HOME-01 | Πρακτικός έλεγχος ελληνικών πινάκων, φίλτρων, ανανέωσης, ποσών, ρόλων και στηλών με προσωρινά δεδομένα. Επιβεβαιώθηκαν αναζήτηση χωρίς τόνους, φίλτρο ποσού και διατήρηση φίλτρου μετά από ανανέωση. Διορθώθηκαν με PR #531 το κλείσιμο popdown κατά την εσωτερική κύλιση, η κατηγορία δικαιούχου και το όνομα χειριστή. | ΣΕ ΕΞΕΛΙΞΗ - LIVE ΕΠΑΝΕΛΕΓΧΟΣ |
...
| DEV-02 | Ενιαία συμπεριφορά φίλτρων, καθαρισμός/διατήρηση φίλτρων και αποθήκευση διάταξης στηλών ανά χρήστη. | ΕΚΚΡΕΜΕΙ |
