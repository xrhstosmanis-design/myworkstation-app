...
- [ ] Μη αναγνωρίσιμο PDF πέρασε λανθασμένα 0,01 € και μείωσε την οφειλή **1.380,14→1.380,13 €**. Διόρθωση απόρριψης πριν από οικονομική εγγραφή AWAITING CI/DEPLOY/LAB. Διπλή υποβολή και ροή χειριστή POS παραμένουν OPEN. Checkpoint `CHECKPOINTS/CHANGES/2026-09-25-gate5-readable-payment-proof-awaiting-lab.md`.
