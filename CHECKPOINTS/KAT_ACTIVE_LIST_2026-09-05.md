...
| --- | --- | --- |
| MOD-01 | Δικαιώματα / πληρωμένα modules ανά ιδιοκτήτη, εταιρεία, κατάστημα, πακέτο και ημερομηνία λήξης. | ΣΕ ΔΟΚΙΜΗ - ROLE MATRIX |
...
- Προστέθηκε read-only matrix δικαιωμάτων ανά κατάστημα: Super Admin πάντα, ιδιοκτήτης μόνο με ενεργή εταιρική/καταστημική άδεια και εργαζόμενος χωρίς owner-only modules εκτός ειδικού δικαιώματος. Στοχευμένα tests 13/13, πλήρες regression 1018/1018, frontend build και invariants PASS· εκκρεμεί πράσινο CI/merge/live έλεγχος.
