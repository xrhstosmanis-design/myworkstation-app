...
- [ ] Read-only έλεγχος στην εμπορική οθόνη `MYWORKSTATION LAB / ΕΡΓΑΣΤΗΡΙΟ ΔΟΚΙΜΩΝ`: 34 αρχειοθετημένα συνημμένα, 11 από τα 12 καταγεγραμμένα τιμολόγια αντιστοιχίστηκαν με συγκεκριμένο αρχείο και αριθμό· ΤΑΛΩΣ 01T00125909 δεν εμφανίστηκε στη θυρίδα και παραμένει τελευταία καταγεγραμμένο POS_QUEUED/POS_RECOVERING. Το πρωτότυπο Καραμολέγκου γράφει **ΙΔΑ**-126-009370 (όχι ΙΑΑ), 6 γραμμές/27,44 €. Από τα τυπωμένα στοιχεία Coffee Union ΤΔΑ0012183 (3/344,53 €) και Καραμολέγκου (6/27,44 €) προστέθηκαν verifier regressions που απορρίπτουν διπλή γραμμή, λάθος ποσότητα και λάθος σύνολο. Στο πραγματικό Coffee job `a1ec2efc-977c-4563-af3c-ce7a57f5091b` η πρώτη μη επαληθευμένη ανάγνωση είχε ήδη DEL005=12 και 4 σειρές· provider 3 σειρές αλλά DEL005=12· reread 4 σειρές, +36,49 € και POS_FAILED. **Δεν εκτελέστηκε νέος OCR provider ή POS υποβολή και δεν διορθώθηκε ακόμη parser. Gate 3 OPEN.** `CHECKPOINTS/CHANGES/2026-09-25-gate3-cross-supplier-evidence-inventory.md`.
