...
- [x] Προστέθηκαν αναζήτηση αγοράς, σύνδεση με κατάλογο, σύγκριση τιμών/margin και tenant-scoped ιστορικό.
- [x] Καμία online ένδειξη δεν αλλάζει αυτόματα τιμές ή απόθεμα.
- [x] Προστέθηκε κεντρική προβολή Super Admin με επιλογή εταιρείας και καταστήματος.
- [x] Προστέθηκε ροή πρότασης τιμής σε κατάσταση `PENDING`, ρητή έγκριση/απόρριψη, κλείδωμα εγγραφής και audit πριν/μετά.
- [x] Προστέθηκε πρόταση παραγγελίας με προϊόν, ποσότητα, φθηνότερη πηγή, βασικό κόστος και υπολογισμένο όφελος· δεν αποστέλλεται αυτόματα παραγγελία.
- [ ] Εκκρεμεί LAB PASS με ενεργό provider και επιβεβαίωση πραγματικών τιμών/όρων χονδρικής.
- [x] LAB FAIL πρώτης αναζήτησης: απομονώθηκαν τα schema/provider σφάλματα και αντικαταστάθηκε το γενικό «εσωτερικό σφάλμα» με ασφαλές fallback και σαφή κατάσταση provider.
...
## 13/09/2026 — Audit και Κέντρο Ελέγχων

- [x] Το αναλυτικό Audit παραμένει στην ξεχωριστή σελίδα «Συμβάντα», όπου υπάρχει ήδη πλήρης φιλτραρισμένη προβολή.
- [x] Αφαιρέθηκε η διπλή ενότητα από το «Έλεγχοι & Αναλύσεις», ώστε εκεί να εμφανίζονται μόνο τα στοχευμένα αποτελέσματα BASIC, COMPLETE και PREMIUM.
- [ ] Εκκρεμεί CI και Render deploy της αφαίρεσης.

## 13/09/2026 — PREMIUM τελικό αποτέλεσμα χωρίς διπλή λίστα

- [x] Με ενεργό PREMIUM εμφανίζονται μόνο τα τελικά αποτελέσματα και η έγκριση ανά κλεισμένη βάρδια.
- [x] Η γενική λίστα «Συμβάντα που χρειάζονται έλεγχο» δεν διπλασιάζει πλέον τα PREMIUM αποτελέσματα.
- [ ] Εκκρεμεί CI, Render deploy και οπτική δοκιμή χρήστη σε LAB.

## 13/09/2026 — PREMIUM τελική κατάσταση

- [x] Με ενεργό PREMIUM η κεντρική κατάσταση δηλώνει «Τελικό αποτέλεσμα ανά βάρδια για έγκριση».
- [x] Αφαιρέθηκε η παραπλανητική γενική ένδειξη «Χρειάζεται επιβεβαίωση» από την PREMIUM ροή.
- [ ] Εκκρεμεί CI, Render deploy και οπτική δοκιμή χρήστη σε LAB.
