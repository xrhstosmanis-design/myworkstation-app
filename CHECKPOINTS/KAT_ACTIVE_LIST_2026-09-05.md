...
- [ ] Gate 3: ξεκίνησε μόνο με άνοιγμα της φόρμας «Νέο / Χειροκίνητο τιμολόγιο» στο MYWORKSTATION LAB / ΕΡΓΑΣΤΗΡΙΟ ΔΟΚΙΜΩΝ. Δεν υποβλήθηκε νέα φόρμα, δεν δημιουργήθηκε δεύτερο τιμολόγιο και δεν μεταβλήθηκαν stock ή οφειλή προμηθευτή.
- [ ] Μοναδικό επόμενο βήμα: ο Χρήστος ελέγχει την ήδη υπάρχουσα πρόχειρη εγγραφή πριν από οποιαδήποτε νέα χειροκίνητη καταχώρηση, ώστε να αποφευχθεί διπλότυπο.
- [x] Κανόνας συνέχειας: κάθε PASS/FAIL καταγράφεται πρώτα εδώ και σε νέο CHECKPOINTS/CHANGES/ αρχείο, πριν αρχίσει το επόμενο test block. Οι δοκιμές εκτελούνται από τον Χρήστο.
