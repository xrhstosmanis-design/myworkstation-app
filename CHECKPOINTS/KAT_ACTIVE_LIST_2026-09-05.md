...
- HOME-01 live έλεγχος στη σωστή σελίδα Platform Admin: 916 συμβάντα ΚΑΤ φορτώθηκαν. Αναζήτηση `διαγραφη` χωρίς τόνο: 122 αποτελέσματα. Φίλτρο ποσού `0,50`: 35 αποτελέσματα. Η ανανέωση διατήρησε ενεργό το φίλτρο. Επιβεβαιώθηκαν τρία θέματα προς διόρθωση: popdown φίλτρου κλείνει κατά την εσωτερική κύλιση, δεν εμφανίζεται η κατηγορία δικαιούχου έκπτωσης και σε ολοκλήρωση πώλησης μπορεί να εμφανιστεί UUID αντί ονόματος χειριστή.
