...
| MOD-11 | Σύγκριση προμηθευτών. | ΥΛΟΠΟΙΗΘΗΚΕ — ΑΝΑΜΟΝΗ ΔΟΚΙΜΗΣ LAB |
...
- 2026-09-09: MOD-11 η υπάρχουσα σύγκριση πραγματικού κόστους προμηθευτών μετατράπηκε σε ξεχωριστό επί πληρωμή owner-only module, με μόνιμη πρόσβαση Super Admin. Χρησιμοποιεί μόνο εγκεκριμένα παραστατικά, κανονικοποίηση κόστους ανά τεμάχιο, τελευταία τιμή, κατάταξη και υπολογισμό οφέλους. Αναμονή CI/Render και δοκιμής LAB.
