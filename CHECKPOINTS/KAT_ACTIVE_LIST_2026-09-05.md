...
- [ ] ΣΕ ΔΟΚΙΜΗ: εντοπίστηκε η πραγματική αιτία της οθόνης — το πρώτο από τρία ίδια `/owner-products/catalog` routes δεν επέστρεφε `supplierName`/`hasSupplier`. Το ενεργό route επιστρέφει πλέον προμηθευτή tenant-safe από σύνδεση/mapping/αγορά και απαγορεύει cache.
...
- [ ] Εκκρεμούν πράσινο CI, deploy και τελική LAB επιβεβαίωση της αναπαραγωγής στο background.
