...
## 25/09/2026 — Gate 3 έκπτωση 25→24,96 στη μετατροπή — LOCAL 20 PASS / AWAITING CI-LAB

Μετά την διαγνωστική συμφωνία ΓΡ, διορθώνεται η αντικατάσταση της τρέχουσας έκπτωσης από ανάστροφο υπολογισμό στρογγυλοποιημένου καθαρού. Το τυπωμένο 25% δίνει σωστά 10,13 €. Δεν χρησιμοποιείται ιστορική έκπτωση. Checkpoint `CHECKPOINTS/CHANGES/2026-09-25-gate3-current-discount-rounding.md`. Gate 3 OPEN.
