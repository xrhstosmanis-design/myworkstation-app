## 2026-09-24 — Gate 3 ΜΟΥΧΛΑΚΗΣ 01/129707 — LAB FAIL / τοπική αλλαγή ανεξάρτητου πίνακα

- [ ] Νέα γνήσια υποβολή από LAB POS 2: έντυπο **14 σειρές, 490 τεμάχια, 1.791,63 €, ΦΠΑ 0%**. Πρόχειρο **26 σειρές, 5.292,24 €**, POS_FAILED. Αρχική συγχωνευμένη ανάγνωση 27 σειρών, 24% σε τυπωμένες γραμμές 0%, μετατόπιση 105,46 € σε 3.163,80 €. Το κουμπί διόρθωσης δεν επαλήθευσε πλήρη πίνακα και κράτησε το πρόχειρο· δεν αποτελεί αποδοχή. Χωρίς οριστικοποίηση/πληρωμή· stock/audit NOT TESTED. Η προηγούμενη σελίδα είχε ήδη πλήρη verifier (#1137), ο οποίος τροφοδοτούνταν εδώ με μολυσμένο οδηγό. Νέα τοπική αλλαγή: γενικό μονοσέλιδο mismatch ξαναδιαβάζεται ανεξάρτητα από την εικόνα και αντικαθίσταται μόνο μετά από πλήρη οικονομική/ΦΠΑ επαλήθευση. 1.456 server PASS, 1 SKIP, build PASS, **AWAITING CI/DEPLOY/νέο LAB**. Gate 3 OPEN. Checkpoint: `CHECKPOINTS/CHANGES/2026-09-24-pos-image-only-verifier-mouchlakis-awaiting-lab.md`.
...
## 2026-09-25 — Gate 4 αντίγραφο NON_FISCAL πώλησης — AWAITING CI / DEPLOY / LAB
