...
- [x] Επισκευή υφιστάμενου CI blocker: ο προηγούμενος κώδικας PREMIUM χρησιμοποιούσε δύο αδήλωτες σταθερές. Προστέθηκαν οι τιμές 40 δευτερολέπτων / 2 συναλλαγών που ήδη απαιτούσε το test του main, χωρίς αλλαγή οικονομικών δεδομένων.
...
- [ ] CI περιλαμβάνει πραγματικό HTTP σενάριο: πληρωμένο πρόχειρο → διαγραφή φωτογραφιών / job → επανεισαγωγή από δεύτερο χρήστη → ακριβώς ίδια πληρωμή, χωρίς επιπλέον stock. Αναμονή πράσινου CI, merge και επιβεβαίωσης Render.
