...
- [ ] Καθολικός κανόνας πολλών ταμείων: όλα τα POS του ίδιου καταστήματος χρησιμοποιούν την ίδια αποθήκη, κοινό τζίρο, κοινά χρήματα και ενιαία Συμβάντα, με ξεχωριστή ανάλυση ανά τερματικό/βάρδια/χειριστή. Ισχύει για 1, 2 ή περισσότερα ταμεία και για όλα τα καταστήματα.
