Warning: truncated output (original token count: 68967)
...
- [x] Root cause: the successful OpenAI F…38967 tokens truncated… Reconciliation now prefers the same DRAFT PurchaseDocument total, then safely falls back to the POS handoff.
