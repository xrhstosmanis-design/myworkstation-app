## 2026-09-22 — Invoice Learning απόρριψη λανθασμένων crop γραμμών — AWAITING CI / DEPLOY

- [x] Οι γραμμές από τα επικαλυπτόμενα crops δεν εμφανίζονται πριν συμφωνήσει το νέο μικτό σύνολο με το δηλωμένο σύνολο του τιμολογίου.
- [x] Σε απόκλιση απορρίπτονται όλες οι πρόσθετες γραμμές και η εκμάθηση παραμένει μπλοκαρισμένη ως ελλιπής.
- [x] Προστέθηκε regression test για αποτροπή του αποτελέσματος με 32 λανθασμένα/διπλά προϊόντα.
- [ ] Πράσινο CI, merge, deploy και νέα πραγματική δοκιμή της ίδιας φωτογραφίας.
- Checkpoint: `CHECKPOINTS/CHANGES/2026-09-22-invoice-learning-reject-invalid-crops.md`

## 2026-09-22 — Invoice Learning πλήρης επανάγνωση πίνακα — AWAITING CI / DEPLOY

- [x] Μετά την αρχική ανάγνωση εικόνας γίνεται αυτόματη μεγέθυνση σε τρία επικαλυπτόμενα τμήματα του πίνακα προϊόντων.
- [x] Οι γραμμές από τα crops συγχωνεύονται χωρίς να χάνονται νέοι κωδικοί/περιγραφές.
- [x] Η «Επιβεβαίωση & Εκμάθηση» μπλοκάρεται όταν ο server επιστρέφει μερικό αποτέλεσμα.
- [ ] Πράσινο CI, merge και deploy και επανέλεγχος του τιμολογίου Στεφανίδη με όλες τις γραμμές.
- Checkpoint: `CHECKPOINTS/CHANGES/2026-09-22-invoice-learning-complete-table-reread.md`
