...
- [ ] Read-only έλεγχος στην εμπορική οθόνη `MYWORKSTATION LAB / ΕΡΓΑΣΤΗΡΙΟ ΔΟΚΙΜΩΝ`: 34 αρχειοθετημένα συνημμένα, 11 από τα 12 καταγεγραμμένα τιμολόγια αντιστοιχίστηκαν με συγκεκριμένο αρχείο και αριθμό· ΤΑΛΩΣ 01T00125909 δεν εμφανίστηκε στη θυρίδα και παραμένει τελευταία καταγεγραμμένο POS_QUEUED/POS_RECOVERING. Το πρωτότυπο Καραμολέγκου γράφει **ΙΔΑ**-126-009370 (όχι ΙΑΑ), 6 γραμμές/27,44 €. Από τα πραγματικά τυπωμένα στοιχεία Coffee Union ΤΔΑ0012183 (3/344,53 €) και Καραμολέγκου (6/27,44 €) προστέθηκαν local verifier regressions που απορρίπτουν διπλή γραμμή, λάθος ποσότητα και λάθος σύνολο. **Δεν εκτελέστηκε νέος OCR provider ή POS υποβολή και δεν διορθώθηκε ακόμη parser. Gate 3 OPEN.** `CHECKPOINTS/CHANGES/2026-09-25-gate3-cross-supplier-evidence-inventory.md`.
