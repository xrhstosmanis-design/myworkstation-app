...
## 2026-09-13 — Gate 3: άμεση επιστροφή στο POS / εργασία ανάγνωσης στον server

- [x] Δεσμευτικός κανόνας Χρήστου: δεν αλλάζει ολοκληρωμένη ροή χωρίς προηγούμενη έγκριση. Οι διορθώσεις προσαρμόζονται στην υπάρχουσα λειτουργία.
- [x] Η γρήγορη καταχώρηση τιμολογίου αποθηκεύει πρώτα όλες τις σελίδες και τα βασικά στοιχεία και κλείνει αμέσως τη φόρμα, ώστε ο χειριστής να συνεχίζει πωλήσεις στο POS.
- [x] Η πλήρης πολυσέλιδη ανάγνωση, η επικύρωση V2.4.4 και η δημιουργία προχείρου μεταφέρθηκαν σε ανεξάρτητη εργασία του server και δεν εξαρτώνται από ανοιχτή φόρμα ή μεγάλη κλήση του browser.
- [x] Τα IDs όλων των σελίδων και τα στοιχεία παράδοσης παραμένουν στο AI job· αν μεσολαβήσει restart του server, το status polling συνεχίζει την αποθηκευμένη εργασία χωρίς νέο upload ή πληρωμή.
