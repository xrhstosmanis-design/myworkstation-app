...
- [ ] Issue #1202: με δύο τεμάχια 0,50 € και υποθετική έκπτωση δικαιούχου 10%, η οθόνη υπολογίζει 1,00 € (στρογγυλοποίηση ανά τεμάχιο), το checkout 0,90 € (ανά γραμμή). Δεν έγινε LAB συναλλαγή. Το ανατεθειμένο σκέλος Gate 4 χρειάζεται κοινό quote/checkout, regression, CI/deploy και μία νέα προμετρημένη δοκιμή· καμία επανάληψη της πώλησης ή της εκτύπωσης 23:22:35. Checkpoint: `CHECKPOINTS/CHANGES/2026-09-25-gate4-discount-quantity-source-finding.md`.
