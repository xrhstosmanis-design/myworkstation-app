...
- 2026-09-09: Το LAB επιβεβαίωσε την κατηγορία «Αποστολή προϊόντων από Master Catalog» στο Audit. Διορθώνεται το οριζόντιο σύρσιμο των αναπτυγμένων γραμμών με ποντίκι και αφή· αναμονή CI/Render και σύντομου retest.
