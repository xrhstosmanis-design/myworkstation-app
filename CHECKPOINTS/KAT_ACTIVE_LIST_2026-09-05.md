...
| MOD-02 | Επέκταση της υπάρχουσας ενότητας Προσφορών με αναλύσεις, επιστροφές, προμηθευτές και Excel/PDF. | ΣΕ ΔΟΚΙΜΗ - PR #550 / merge `e393ae96` · read-only λίστα προσφορών ΟΚ. Νέα POS πώληση κρατά το συγκεκριμένο promotionId και η ανάλυση εμφανίζει μόνο πραγματικές μελλοντικές πωλήσεις/εκπτώσεις/επιστροφές χωρίς αναδρομική απόδοση παλαιών γραμμών. |
