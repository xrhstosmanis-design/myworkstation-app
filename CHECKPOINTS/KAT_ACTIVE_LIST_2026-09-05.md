...
- [ ] Πλήρες CI / merge στο `main` / ακριβές Render revision.
...
- [ ] LIVE δοκιμή αποκλειστικά από τον Χρήστο μετά το deploy: δεύτερος χειριστής επιχειρεί το ίδιο τιμολόγιο και λαμβάνει μπλοκάρισμα χωρίς νέα κίνηση.
