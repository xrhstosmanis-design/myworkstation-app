## 2026-09-22 — Εκκρεμή Barcodes σε κουμπί — IN PROGRESS

- [x] Η μεγάλη λίστα δεν εμφανίζεται πλέον ανοιχτή στην αρχική φόρτωση.
- [x] Ανοίγει μόνο από το κουμπί «Εκκρεμή Barcodes».
