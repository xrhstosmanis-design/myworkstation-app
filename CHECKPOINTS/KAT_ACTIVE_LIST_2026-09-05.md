## 2026-09-10 — Αυτόματη λήψη τιμολογίων myDATA στη Θυρίδα (LAB)

- Υλοποιήθηκε λήψη `RequestDocs` με κρυπτογραφημένους κωδικούς ανά κατάστημα, αποκλειστικά σε `SANDBOX`.
- Τα νέα παραστατικά μπαίνουν ως πρόχειρα με MARK/UID/ΑΦΜ/αριθμό/ημερομηνία/σύνολα και προστασία από διπλοκαταχώρηση.
- Προστέθηκαν χειροκίνητη «Λήψη από myDATA» και δεκάλεπτος έλεγχος όσο είναι ανοιχτή η Θυρίδα.
- Δεν γίνεται φορολογική αποστολή και δεν αλλάζει απόθεμα πριν από έλεγχο PDF/OCR και επιβεβαίωση.
- Automated: 5/5 στοχευμένα, client build PASS, server 1.058/1.058 PASS. Αναμονή CI/Render και LAB δοκιμής με δοκιμαστικούς κωδικούς ΑΑΔΕ.
- Checkpoint: `CHECKPOINTS/CHANGES/2026-09-10-mydata-invoice-inbox-lab-sync.md`.

## 2026-09-10 — Χειροκίνητη επιστροφή σε προμηθευτή

- Από το δεξί κλικ είδους προστέθηκε «Επιστροφή σε προμηθευτή» με υποχρεωτικό ενεργό προμηθευτή, ποσότητα και αιτιολογία.
- Η πράξη μειώνει ατομικά το stock μία φορά, δεν επιτρέπει ποσότητα μεγαλύτερη από το διαθέσιμο και εμφανίζεται στο Audit ως «Επιστροφή σε προμηθευτή».
- Κάθε επιστροφή λαμβάνει μοναδικό αναγνωριστικό για μελλοντική σύνδεση πιστωτικού χωρίς δεύτερη αφαίρεση.
- Αναμονή πράσινου CI/Render και LAB live δοκιμής. Το ΚΑΤ δεν επηρεάζεται.
