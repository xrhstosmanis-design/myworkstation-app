...
## 25/09/2026 — Gate 3: ρητή διόρθωση κωδικού προϊόντος — LOCAL 16 PASS / AWAITING CI-LAB

Η Coffee0012183 διαβάζει την πρώτη τυπωμένη γραμμή ES21005 ως L. S21005. Προστίθεται SuperAdmin κανόνας δεμένος με ΑΦΜ + παρατηρημένο κωδικό + ακριβή περιγραφή, πριν από το canonical mapping, με προστασία από workspace autosync. Δεν είναι γενικό LS→ES και δεν επιλέγει barcode/Master. Διατηρούνται3/344,53€,25/25/34,08% και KG→GR. Νέο POS και όλοι οι προμηθευτές NOT TESTED, Gate3 OPEN. Checkpoint `CHECKPOINTS/CHANGES/2026-09-25-gate3-explicit-code-correction.md`.
...
- [x] Focused tests `65…37201 tokens truncated…Αναμονή CI/deploy και μία διαγνωστική επανάληψη για την ακριβή τελική διόρθωση.
