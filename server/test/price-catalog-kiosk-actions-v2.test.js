...
test("leaflet new entry follows Kiosk fields",()=>{const c=read(controller);for(const label of ["Νέα προσφορά για Φυλλάδιο","Είδος:","Κωδικός / Barcode:","Υποκατηγορία:","Τρέχουσα τιμή:","Νέα τιμή:","% έκπτωσης:","Ισχύει από:","Bonus πόντοι:","Ισχύει έως και:","Επιστροφή","Καταχώρηση"])assert.ok(c.includes(label),label)});
