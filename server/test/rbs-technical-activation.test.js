...
test("commercial license update cannot newly enable a technical module",()=>{assert.match(route,/alreadyTechnicallyActive/);assert.match(route,/!catalogModule\?\.commercialReady&&!alreadyTechnicallyActive/)});
