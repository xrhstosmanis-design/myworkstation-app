...
const schema={type:"object",additionalProperties:false,required:["expectedPageCount","visiblePageNumbers","singlePageComplete","printedTotal","lines"],properties:{expectedPageCount:{type:"integer"},visiblePageNumbers:{type:"array",items:{type:"integer"}},singlePageComplete:{type:"boolean"},printedTotal:{type:"string"},lines:{type:"array",items:rowSchema}}};
