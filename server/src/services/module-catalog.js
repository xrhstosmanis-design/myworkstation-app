export const moduleCatalog=[
  ...
  {key:"ONLINE_ORDERING",name:"Online Store / Παραγγελίες",description:"Προαιρετικό online κατάστημα ανά πελάτη και κατάστημα, με Delivery/Pickup, online τιμές, σύνδεση POS, stock και audit.",category:"OPERATIONS",commercialReady:true},
  ...
  {key:"VIDEO_EVENTS",name:"Video Events / Κάμερες",description:"Σύνδεση συμβάντων Audit με το NVR/DVR ή τις IP κάμερες κάθε καταστήματος, με περιορισμένη πρόσβαση και καταγραφή προβολών.",category:"SECURITY",commercialReady:false,requiresTechnicalActivation:true},
...
export function catalogView(entitlements=[],commercialTerms=[]){
  ...
  return moduleCatalog.map(module=>{
    ...
    return {
      ...
      monthlyPrice:Number(terms?.monthlyPrice||0),setupFee:Number(terms?.setupFee||0),billingCycle:terms?.billingCycle||"MONTHLY",currency:terms?.currency||"EUR"
    };
  });
}
