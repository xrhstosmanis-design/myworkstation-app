export const moduleCatalog=[
  ...
  {key:"ONLINE_RADIO",name:"Online Ράδιο",description:"Εσωτερικός player POS με κεντρικά διαχειριζόμενους και επιτρεπόμενους σταθμούς ανά κατάστημα.",category:"POS",commercialReady:true,monthlyPriceEur:4.9},
