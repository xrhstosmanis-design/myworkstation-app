  ...
  try{
    ...
    const rows=await prisma.$queryRaw`
      ...
      WHERE "companyId"=${req.user.companyId}
        AND ("status" IN ('POS_QUEUED','POS_DRAFT_READY','POS_FAILED') OR ("status"='POS_PROCESSING' AND "updatedAt"<${staleBefore}) OR "status"='AWAITING_APPROVAL')
