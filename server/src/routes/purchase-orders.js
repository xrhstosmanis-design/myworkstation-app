...
async function learnConfirmedLineCorrection(tx,{companyId,supplierId,line,userId}){
  ...
  await tx.$executeRaw`
    INSERT INTO "SupplierProductMapping" (
      ...
      ${id()},${companyId},${supplierId},${supplierCode},${productId},${line.description||null},${Number(line.stockUnitsPerInvoiceUnit||0)>1?Number(line.stockUnitsPerInvoiceUnit):null},${n(line.unitCost)},${n(line.discount1)},${n(line.discount2)},${n(line.discount3)},${n(line.exciseTotal)/quantity},${n(line.markupPercent)},1,${userId||null},NOW(),NOW(),NOW(),NOW()
    )
