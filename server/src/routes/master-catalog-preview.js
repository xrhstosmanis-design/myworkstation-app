...
router.post("/preview",async(req,res,next)=>{
  try{
    ...
    // Dedicated preview: one workbook read only, keeping memory stable on Render.
    ...
    res.json({
      ...
      safety:{duplicateBarcodeScanDisabled:true,zeroRetailBecomesNull:true,zeroVatIsValid:true,stockNotImportedIntoStores:true}
    });
