...
export async function ensureKatPreparationCleanup(){
 ...
 console.log(`KAT preparation cleanup (${store.name}): deactivated ${remove.length} legacy/duplicate drink products`);
 return {ok:true,removed:remove.length,storeId:store.id};
}
