...
`ALTER TABLE "Product" ADD COLUMN IF NOT EXISTS "staffPrice" DECIMAL(14,4)`,
`ALTER TABLE "Product" ADD COLUMN IF NOT EXISTS "deliveryPrice" DECIMAL(14,4)`,
`ALTER TABLE "Product" ADD COLUMN IF NOT EXISTS "minOrderQuantity" DECIMAL(14,4)`,
`ALTER TABLE "Product" ADD COLUMN IF NOT EXISTS "capacity" DECIMAL(14,4)`,
`ALTER TABLE "Product" ADD COLUMN IF NOT EXISTS "allowDiscount" BOOLEAN NOT NULL DEFAULT true`,
`ALTER TABLE "Product" ADD COLUMN IF NOT EXISTS "allowPosPriceChange" BOOLEAN NOT NULL DEFAULT false`,
`ALTER TABLE "Product" ADD COLUMN IF NOT EXISTS "freeSalePrice" BOOLEAN NOT NULL DEFAULT false`,
`ALTER TABLE "Product" ADD COLUMN IF NOT EXISTS "negativeStockWarning" BOOLEAN NOT NULL DEFAULT false`,
`ALTER TABLE "Product" ADD COLUMN IF NOT EXISTS "isSet" BOOLEAN NOT NULL DEFAULT false`,
`ALTER TABLE "Product" ADD COLUMN IF NOT EXISTS "isRecipe" BOOLEAN NOT NULL DEFAULT false`,
...
`CREATE UNIQUE INDEX IF NOT EXISTS "ProductSetItem_unique" ON "ProductSetItem"("companyId","productId","relatedProductId")`,
`ALTER TABLE "Product" ADD COLUMN IF NOT EXISTS "discountA" DECIMAL(6,3) NOT NULL DEFAULT 0`,
`ALTER TABLE "Product" ADD COLUMN IF NOT EXISTS "discountB" DECIMAL(6,3) NOT NULL DEFAULT 0`,
`ALTER TABLE "Product" ADD COLUMN IF NOT EXISTS "discountC" DECIMAL(6,3) NOT NULL DEFAULT 0`,
`ALTER TABLE "ProductBarcode" ADD COLUMN IF NOT EXISTS "salePrice" DECIMAL(14,4)`,
`ALTER TABLE "ProductBarcode" ADD COLUMN IF NOT EXISTS "name" TEXT`,
`ALTER TABLE "ProductBarcode" ADD COLUMN IF NOT EXISTS "updatedAt" TIMESTAMPTZ NOT NULL DEFAULT NOW()`,
`CREATE TABLE IF NOT EXISTS "SupplierProductLink" (
